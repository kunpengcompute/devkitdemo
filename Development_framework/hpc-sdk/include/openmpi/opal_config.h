...
/* Define to 1 if you have the <ucg/api/ucg.h> header file. */
#define HAVE_UCG_API_UCG_H 1
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='clang' CFLAGS='-DNDEBUG -O3 -g -fstack-protector-strong -fPIE -pie -lstdc++ -DHAVE___CLEAR=1 -Wno-error=deprecated-declarations -Wno-unused-command-line-argument -Wno-error -finline-functions -fno-strict-aliasing  -D__EXTENSIONS__' CPPFLAGS='-I/usr1/workspace/HMPI_hmpi_Compile_OpenEuler22.03SP2_Bisheng3.0.0_MLNX5.8_aarch64/hmpi/opal/mca/event/libevent2022/libevent -I/usr1/workspace/HMPI_hmpi_Compile_OpenEuler22.03SP2_Bisheng3.0.0_MLNX5.8_aarch64/hmpi/opal/mca/event/libevent2022/libevent/include -I/usr1/workspace/HMPI_hmpi_Compile_OpenEuler22.03SP2_Bisheng3.0.0_MLNX5.8_aarch64/hmpi/opal/mca/hwloc/hwloc201/hwloc/include   -I/usr/local/include -I/usr/local/include' FFLAGS='' LDFLAGS='-Wl,-z,relro,-z,now,-z,noexecstack,-s ' --enable-shared --disable-static  --prefix=/usr1/workspace/HMPI_hmpi_Compile_OpenEuler22.03SP2_Bisheng3.0.0_MLNX5.8_aarch64/hmpi/build/.. --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_FC "flang"

/* Absolutey path to the underlying Fortran compiler found by configure */
#define OMPI_FC_ABSOLUTE "/opt/compiler/BiSheng-compiler-3.0.0-aarch64-linux/bin/flang"
...
#define OMPI_FORTRAN_IGNORE_TKR_PREDECL "!DIR$ IGNORE_TKR"
...
#define OMPI_REPO_REV "v2.0.0.RC1-huawei-2-g951640a452"
...
#define OMPI_SIZEOF_FORTRAN_COMPLEX4 8
...
#define OPAL_HAVE_ATTRIBUTE_OPTNONE 1
...
#define OPAL_IDENT_STRING "4.1.1rc4"
...
#define OPAL_PACKAGE_STRING "Open MPI root@localhost.localdomain Distribution"
...
#define ORTE_REPO_REV "v2.0.0.RC1-huawei-2-g951640a452"
