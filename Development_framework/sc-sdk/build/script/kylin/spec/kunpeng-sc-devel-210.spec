...
BuildRequires:  gcc
Requires:       openssl-devel zlib-devel kernel-devel kunpeng-sc = %{PackageVersion}

Conflicts: TEE_SDK TEE-devel_SDK

%description
Kunpeng sc devel for Secure Computing Application Development. Support os: Kylin V10.
