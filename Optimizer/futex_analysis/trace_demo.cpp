...
__attribute__((noinline))
void NativeHotStage(ProcessContext& ctx)
{
...
__attribute__((noinline))
uint64_t Process(const uint8_t* input, size_t inputSize,
                         int computeRounds, int writeCount)
{
    ProcessContext ctx;
    ctx.input = input;
