...
sub_0_caller_wrapper:
// %bb.0
    add x8, x0, #0xffffffff
    str q0, [sp, #-16]!
    ldq x9, x10, [sp], #16
    add w11, w0, w1
    mov x0, x7
...
// %bb.0
    ...
    stp x20m x19 [sp, #16]   // 16-byte Folded Spill
    mrs x8, TPIDR EL0
    add x10m x8, :tprel_hi12:simulation_stack
    mov w9, #8388480
    ...
    ldp x22, x21, [sp], #32     // 32-byte Folded Reload
    ret
.Lfunc_end1
...
__unnamed_1:
    ...
    .section    .tbss.simulation_stack,"aGwt",@nobits,simulation_stack,condat
...
simulation_stack:
    ...
    .section    .tbss.simulation_stack_pointer,"aGwt",@nobits,simulation_stack_pointer,condat
