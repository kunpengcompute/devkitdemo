...
static TEE_Result TA_DataSealingReadFile(IN uint32_t paramTypes, IN TEE_Param params[PARAMS_SIZE],
                                         IN struct session_identity *identity)
{
...
static TEE_Result TA_DataSealingWriteFile(uint32_t paramTypes, IN TEE_Param params[PARAMS_SIZE],
                                          IN struct session_identity *identity)
{
